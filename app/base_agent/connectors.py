...
class Connector():
    ...
    def make_tool_calls(self, toolcalls):
...
class OpenAIConnector(Connector):
    ...
    def _adapt_chat_history(self, chat_history):
        ...
        for msg in chat_history:
            ...
            if "content" in msg:
                adapted_message["content"] = msg.get("content", "")
    ...
    def get_response(self, chat_history=None, system_message=None, model="gpt-4o", max_tokens=None, temperature=0.7, 
        ...
        if model in ["gpt-4o-search-preview", "gpt-4o-mini-search-preview"]:
            kwargs = {"web_search_options": {}}
        if model in ["o3-mini", "o1", "o4-mini"]:
            kwargs = {"max_completion_tokens": max_tokens}
            if model in ["o3-mini", "o1"]:
                system_message[0]["role"] = self.supported_roles[5]
                if reasoning is None:
                    kwargs['reasoning_effort'] = "high"
                elif reasoning.lower() in self.reasoning:
        ...
        prompt_token_cost = {"gpt-4o": 0.0000025, "gpt-4o-mini": 0.00000015, "o4-mini" : 0.0000011, "o3-mini": 0.0000011, "o1": 0.000015, "gpt-4.1": 0.000002, "gpt-4.1-mini": 0.0000004}
        output_token_cost = {"gpt-4o": 0.000010, "gpt-4o-mini": 0.0000006, "o4-mini" : 0.0000044, "o3-mini": 0.0000044, "o1": 0.000060, "gpt-4.1": 0.000008, "gpt-4.1-mini": 0.0000016}
    ...
    def get_agent_response(self, response, name):
        ...
        for single_response in response:
            if single_response["type"] == "content":
                agent_response["content"] = single_response["value"]
